/**
 * OpenCage Data Geocoding Control v3.0.0-alpha.2 - 2026-05-11
...
(function(global, factory) {
	typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("leaflet"), require("opencage-api-client")) : typeof define === "function" && define.amd ? define([
		"exports",
		"leaflet",
		"opencage-api-client"
	], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global["leaflet-control-opencage-geocoding"] = {}, global.L, global.opencage_api_client));
})(this, function(exports, leaflet, opencage_api_client) {
		...
		_processResults(data) {
			...
			for (let i = data.results.length - 1; i >= 0; i--) {
				results[i] = {
					...
					center: new leaflet.LatLng(data.results[i].geometry.lat, data.results[i].geometry.lng)
				};
				if (data.results[i].bounds) results[i].bounds = new leaflet.LatLngBounds([data.results[i].bounds.southwest.lat, data.results[i].bounds.southwest.lng], [data.results[i].bounds.northeast.lat, data.results[i].bounds.northeast.lng]);
	...
	*/
	var OpenCageGeocodingControl = class extends leaflet.Control {
		constructor(options = {}) {
			super(options);
			this.options = {
